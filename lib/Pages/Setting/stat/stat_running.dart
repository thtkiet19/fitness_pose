...
class stat_running extends StatefulWidget {
  ...
  stat_running({Key? key, this.progress, required this.goal_val})
      : super(key: key);
  @override
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Expanded(
                  child: BarChart(
                    BarChartData(
                      maxY: widget.goal_val.jogging_goal,
                          ...
                          getTitles: (value) {
                            if (value == 0) {
                              return '0';
                                ...
                                (widget.goal_val.jogging_goal! / 2)) {
                              return '${(widget.goal_val.jogging_goal! / 2).ceil()}';
                            } else if (value == widget.goal_val.jogging_goal) {
                              return '${widget.goal_val.jogging_goal!.ceil()}';
                            } else {
                              return '';
                            }
                          },
